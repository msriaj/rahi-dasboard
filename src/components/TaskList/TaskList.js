                            ...
                            <tr className="focus:outline-none h-16 border border-gray-100 rounded">
                                <td className="">
                                    <div className="flex items-center pl-5">
                                        <p className="text-base font-medium leading-none text-gray-700 mr-2">Script TitleScript TitleScript </p>
                                ...
                                <td className="pl-5">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm leading-none text-gray-600 ml-2">Customer Name</p>
                                    </div>
                                </td>
                                <td className="pl-24">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm leading-none text-red-600 ml-2">Urgent</p>
                                    </div>
                                </td>
                                <td className="pl-5">
                                    <div className="flex items-center">

                                        <p className="text-sm leading-none text-gray-600 ml-2">04/07/2022</p>
                                    </div>
                                </td>


                                <td className="pl-5">
                                    <button className="py-3 px-3 text-sm focus:outline-none leading-none text-green-700 font-bold rounded">Delivered </button>
                                </td>
                                <td className="pl-4">
                                ...
                                <td className="pl-4">
                                    <button className="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-white font-bold py-3 px-5 bg-green-600 rounded hover:bg-green-700 focus:outline-none">Complete</button>
                                </td>
