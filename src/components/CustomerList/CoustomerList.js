...
const CoustomerList = () => {
    return (
        <div>
            <h2 className='mx-4 text-2xl font-bold mb-2'> Customer list</h2>
            <div className="flex-none w-full max-w-full px-3">

                <div className="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border shadow-lg">
                    ...
                    <div className="flex-auto px-0 pt-0 pb-2">
                        <div className="p-0 overflow-x-auto ps">
                            <table className="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                            <a href="#home" className="font-semibold leading-tight text-xs text-slate-400"> Edit </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td className="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-2 align-middle bg-transparent border-b-0 whitespace-nowrap shadow-transparent">
                                            mclass           <p className="mb-0 font-semibold leading-tight text-xs">Programtor</p>
                                            <p className="mb-0 leading-tight text-xs text-slate-400">Developer</p>
                                        </td>
                            ...
                            <div className="ps__rail-x"  ><div className="ps__thumb-x" tabindex="0"  ></div></div><div className="ps__rail-y"  ><div className="ps__thumb-y" tabindex="0"  ></div>
                            </div></div>
                    </div>
                </div>
            </div>
